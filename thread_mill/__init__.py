...
"""Main entry point for thread_mill.
...
Example:
    ...
    launch thread_mill by saying::

        $ thread_mill --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='thread_mill',
                          vcp_name='thread_mill',
